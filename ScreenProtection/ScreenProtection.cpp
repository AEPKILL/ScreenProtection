...
bool ScreenProtection::Init(PTCHAR configFilePath)
{
...
void ScreenProtection::DrawLine(Gdiplus::Graphics* graphics, int x, int y, int length, int width)
{
	Pen pen(Color((int)255 * 0.25, 255, 255, 255),width);
	graphics->DrawLine(&pen, x, y, x + length, y);
}

ScreenProtection::ScreenProtection(int width , int height)
{
